...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "fma.rn.f64 %r13, %r29, %r13, %r12;\n\t" 
                    "fma.rn.f64 %r14, %r29, %r14, %r12;\n\t" 
                    "fma.rn.f64 %r15, %r29, %r15, %r12;\n\t" 
                    "fma.rn.f64 %r16, %r29, %r16, %r12;\n\t" 
                    "fma.rn.f64 %r17, %r29, %r17, %r12;\n\t" 
                    "fma.rn.f64 %r18, %r29, %r18, %r12;\n\t" 
                    "fma.rn.f64 %r19, %r29, %r19, %r12;\n\t" 
                    "fma.rn.f64 %r20, %r29, %r20, %r12;\n\t" 
                    "fma.rn.f64 %r21, %r29, %r21, %r12;\n\t" 
                    "fma.rn.f64 %r22, %r29, %r22, %r12;\n\t" 
                    "fma.rn.f64 %r23, %r29, %r23, %r12;\n\t" 
                    "fma.rn.f64 %r24, %r29, %r24, %r12;\n\t" 
                    "fma.rn.f64 %r25, %r29, %r25, %r12;\n\t" 
                    "fma.rn.f64 %r26, %r29, %r26, %r12;\n\t" 
                    "fma.rn.f64 %r27, %r29, %r27, %r12;\n\t" 
                    "fma.rn.f64 %r28, %r29, %r28, %r12;\n\t" 
                    "fma.rn.f64 %r13, %r29, %r13, %r12;\n\t" 
                    "fma.rn.f64 %r14, %r29, %r14, %r12;\n\t" 
                    "fma.rn.f64 %r15, %r29, %r15, %r12;\n\t" 
                    "fma.rn.f64 %r16, %r29, %r16, %r12;\n\t" 
