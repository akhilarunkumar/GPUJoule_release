...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "add.rn.f64 %r13, %r12, %r13;\n\t" 
                    "add.rn.f64 %r14, %r12, %r14;\n\t" 
                    "add.rn.f64 %r15, %r12, %r15;\n\t" 
                    "add.rn.f64 %r16, %r12, %r16;\n\t" 
                    "add.rn.f64 %r17, %r12, %r17;\n\t" 
                    "add.rn.f64 %r18, %r12, %r18;\n\t" 
                    "add.rn.f64 %r19, %r12, %r19;\n\t" 
                    "add.rn.f64 %r20, %r12, %r20;\n\t" 
                    "add.rn.f64 %r21, %r12, %r21;\n\t" 
                    "add.rn.f64 %r22, %r12, %r22;\n\t" 
                    "add.rn.f64 %r23, %r12, %r23;\n\t" 
                    "add.rn.f64 %r24, %r12, %r24;\n\t" 
                    "add.rn.f64 %r25, %r12, %r25;\n\t" 
                    "add.rn.f64 %r26, %r12, %r26;\n\t" 
                    "add.rn.f64 %r27, %r12, %r27;\n\t" 
                    "add.rn.f64 %r28, %r12, %r28;\n\t" 
                    "add.rn.f64 %r13, %r12, %r13;\n\t" 
                    "add.rn.f64 %r14, %r12, %r14;\n\t" 
                    "add.rn.f64 %r15, %r12, %r15;\n\t" 
                    "add.rn.f64 %r16, %r12, %r16;\n\t" 
