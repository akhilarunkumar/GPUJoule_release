...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "fma.rn.f32 %r13, %r11, %r13, %r12;\n\t" 
                    "fma.rn.f32 %r14, %r11, %r14, %r12;\n\t" 
                    "fma.rn.f32 %r15, %r11, %r15, %r12;\n\t" 
                    "fma.rn.f32 %r16, %r11, %r16, %r12;\n\t" 
                    "fma.rn.f32 %r17, %r11, %r17, %r12;\n\t" 
                    "fma.rn.f32 %r18, %r11, %r18, %r12;\n\t" 
                    "fma.rn.f32 %r19, %r11, %r19, %r12;\n\t" 
                    "fma.rn.f32 %r20, %r11, %r20, %r12;\n\t" 
                    "fma.rn.f32 %r21, %r11, %r21, %r12;\n\t" 
                    "fma.rn.f32 %r22, %r11, %r22, %r12;\n\t" 
                    "fma.rn.f32 %r23, %r11, %r23, %r12;\n\t" 
                    "fma.rn.f32 %r24, %r11, %r24, %r12;\n\t" 
                    "fma.rn.f32 %r25, %r11, %r25, %r12;\n\t" 
                    "fma.rn.f32 %r26, %r11, %r26, %r12;\n\t" 
                    "fma.rn.f32 %r27, %r11, %r27, %r12;\n\t" 
                    "fma.rn.f32 %r28, %r11, %r28, %r12;\n\t" 
                    "fma.rn.f32 %r13, %r11, %r13, %r12;\n\t" 
                    "fma.rn.f32 %r14, %r11, %r14, %r12;\n\t" 
                    "fma.rn.f32 %r15, %r11, %r15, %r12;\n\t" 
                    "fma.rn.f32 %r16, %r11, %r16, %r12;\n\t" 
