...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "add.rn.f32 %r13, %r11, %r13;\n\t" 
                    "add.rn.f32 %r14, %r11, %r14;\n\t" 
                    "add.rn.f32 %r15, %r11, %r15;\n\t" 
                    "add.rn.f32 %r16, %r11, %r16;\n\t" 
                    "add.rn.f32 %r17, %r11, %r17;\n\t" 
                    "add.rn.f32 %r18, %r11, %r18;\n\t" 
                    "add.rn.f32 %r19, %r11, %r19;\n\t" 
                    "add.rn.f32 %r20, %r11, %r20;\n\t" 
                    "add.rn.f32 %r21, %r11, %r21;\n\t" 
                    "add.rn.f32 %r22, %r11, %r22;\n\t" 
                    "add.rn.f32 %r23, %r11, %r23;\n\t" 
                    "add.rn.f32 %r24, %r11, %r24;\n\t" 
                    "add.rn.f32 %r25, %r11, %r25;\n\t" 
                    "add.rn.f32 %r26, %r11, %r26;\n\t" 
                    "add.rn.f32 %r27, %r11, %r27;\n\t" 
                    "add.rn.f32 %r28, %r11, %r28;\n\t" 
                    "add.rn.f32 %r13, %r11, %r13;\n\t" 
                    "add.rn.f32 %r14, %r11, %r14;\n\t" 
                    "add.rn.f32 %r15, %r11, %r15;\n\t" 
                    "add.rn.f32 %r16, %r11, %r16;\n\t" 
