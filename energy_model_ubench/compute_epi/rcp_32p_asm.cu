...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "rcp.approx.f32 %r13, %r13;\n\t" 
                    "rcp.approx.f32 %r14, %r14;\n\t" 
                    "rcp.approx.f32 %r15, %r15;\n\t" 
                    "rcp.approx.f32 %r16, %r16;\n\t" 
                    "rcp.approx.f32 %r17, %r17;\n\t" 
                    "rcp.approx.f32 %r18, %r18;\n\t" 
                    "rcp.approx.f32 %r19, %r19;\n\t" 
                    "rcp.approx.f32 %r20, %r20;\n\t" 
                    "rcp.approx.f32 %r21, %r21;\n\t" 
                    "rcp.approx.f32 %r22, %r22;\n\t" 
                    "rcp.approx.f32 %r23, %r23;\n\t" 
                    "rcp.approx.f32 %r24, %r24;\n\t" 
                    "rcp.approx.f32 %r25, %r25;\n\t" 
                    "rcp.approx.f32 %r26, %r26;\n\t" 
                    "rcp.approx.f32 %r27, %r27;\n\t" 
                    "rcp.approx.f32 %r28, %r28;\n\t" 
                    "rcp.approx.f32 %r13, %r13;\n\t" 
                    "rcp.approx.f32 %r14, %r14;\n\t" 
                    "rcp.approx.f32 %r15, %r15;\n\t" 
                    "rcp.approx.f32 %r16, %r16;\n\t" 
