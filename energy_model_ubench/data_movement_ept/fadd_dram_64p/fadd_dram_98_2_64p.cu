...
void parametric_measure_shared(int N, int iterations, int stride) {
    ...
    std::string cmd = "GPUJOULE_DIR/nvml/example/power_monitor 5 > GPUJOULE_DIR/energy_model_ubench/energy_model_data/data_movement_energy/dram/fadd_dram_98_2_64p_asm_power.txt &";
