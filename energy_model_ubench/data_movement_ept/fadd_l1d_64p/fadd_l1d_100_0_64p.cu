...
//    cudaMemcpy(d_C, h_C, sizeof(float), cudaMemcpyHostToDevice);
    ...
    std::string cmd = "GPUJOULE_DIR/nvml/example/power_monitor 5 > GPUJOULE_DIR/energy_model_ubench/energy_model_data/data_movement_energy/l1_cache/fadd_64p_asm_power.txt &";
