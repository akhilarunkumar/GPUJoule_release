...
void parametric_measure_shared(int N, int iterations, int stride) {
    ...
    std::string cmd = "GPUJOULE_DIR/nvml/example/power_monitor 5 > GPUJOULE_DIR/energy_model_ubench/energy_model_data/data_movement_energy/l1_cache/fadd_l1d_50_50_64p_asm_power.txt &";
    std::string cmd = "/home/aarunkum/cuda_microbenchmarks/nvml/example/power_monitor 5 > /home/aarunkum/cuda_microbenchmarks/mem_microbenchmarks/fadd_approach/fadd_l1d_64p_v2/fadd_l1d_50_50_64p_power.txt &";
